# Entregable Semana 1 - Introducción al entorno de trabajo
...
| 1.1 Gestión de usuarios y grupos | Completado | [ejercicio-1.1](ejercicio-1.1-usuarios.md) |
...
- Documento ejercicio 1.1: creación de usuarios (webadmin, dbadmin, deploy), grupos (backend, frontend) y directorio /proyecto con permisos
- Documento ejercicio 1.2: instalación de Nginx, gestión con systemctl (start/stop/enable), consulta de logs con journalctl
...
| Equipo | IP | SO | Rol |
|--------|----|----|-----|
| PC local | - | Ubuntu | Desarrollo y documentación |
| Nodo Proxmox | 10.160.218.10 | Proxmox VE 8.4.17 | Hipervisor |

- Acceso SSH con clave pública al nodo Proxmox
